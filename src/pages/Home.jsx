                    ...
                    <form onSubmit={handleSubmit(onSubmit)} action="">
                        ...
                        <div className="px-3 py-2">
                            ...
                            <div className="mt-2">
                                ...
                                <h3
                                    className={`text-[13px] font-Montserrat italic mt-5 ${
                                        errors["Type of Session"]
                                            ? "text-red-600"
                                            : ""
                                    }`}
                                ...
                                <div className="relative mt-5">
                                    <input
                                        ...
                                        {...register("Special Request", {
                                            required: false,
                                        })}
                                    />
                                    <label className="label">
                                        Specific Requests or Theme (optional)
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="px-3 py-2">
                            ...
                            <div className="flex flex-col gap-y-3">
                                ...
                                <div className="relative mt-3">
                                    <input
                                        name="Photo Booth (Specify)"
                                        type="text"
                                        className="peer input"
                                        placeholder="Others*"
                                        {...register("Photo Booth (Specify)", {
                                            required: false,
                                        })}
                                    />
                                    <label className="label">
                        ...
                        <div className="px-3 py-2">
                            <h1
                                className={`font-Belanosima border-black mb-3  border-2 border-x-0 border-t-0 py-1 text-black text-[17px] ${
                                    errors["Payment Type"] ? "text-red-600" : ""
                                }`}
                            >
                                Payment Method
                            </h1>{" "}
                        ...
                        <div className="px-3 py-2">
                            ...
                            <div className="flex flex-col gap-y-3 text-gray-600 text-[15px]">
                                <div className="flex items-center gap-x-3">
                                    ...
                                    >
                                        I, the undersigned, agree to the terms
